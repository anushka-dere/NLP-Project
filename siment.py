...
def add_bg_from_local():
    st.markdown(
        ...
        <style>
        .stApp {{
            background-image: url("https://github.com/BhorRaj/productreviews-analysis/blob/main/white.jpeg");
...
file = "https://github.com/BhorRaj/productreviews-analysis/blob/main/Product_details.csv?raw=true"
az = pd.read_csv(file) 
...
tf.loc[:,"Product_Type"] = product_type
tf.loc[:,"Polarity_score"] = polar
